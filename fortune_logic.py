                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": (
    "手相の写真を見て、以下の形式で日本語で出力してください：\n\n"
    "### 1. 生命線\n（説明文）\n\n"
    "### 2. 知能線\n（説明文）\n\n"
    "### 3. 感情線\n（説明文）\n\n"
    "### 4. 運命線\n（説明文）\n\n"
    "### 5. 特徴的な線\n"
    "ますかけ線、KY線、覇王線、ラッキーM、仏眼、あやまりま線、フィッシュ、S線、M線などの珍しいまたは話題性のある線が写真から確認できた場合は、最優先で取り上げてください。他の項目を短縮してでも、特徴的な線の魅力や意味を詳しく解説し、楽しく盛り上げてください。\n"
    "もし特徴的な線が確認できない場合は「無い」「見られない」「見受けられない」「確認できない」など確認できない事実は一切書かず、全体の手相から読み取れる個性や魅力を自然な形で丁寧に表現してください。\n\n"
    "### 総合的なアドバイス\n（全体を踏まえた前向きで印象に残るまとめ）\n\n"
    "・各項目は400文字前後で、適度に改行や記号を使って見やすく整えてください\n"
    "・言葉遣いは温かく、読み手が前向きな気持ちになれるように\n"
    "・「占ってもらってよかった」と思えるように、1か所は印象的なコメントを盛り込んでください"
)
,
                        },
                        {
