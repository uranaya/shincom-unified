                    ...
                    "content": [
                        {
                            ...
                            "text": (
                                ...
                                "■ 運命線\n（説明文）\n\n"
                                "■ 特徴的な線\n"
                                "ますかけ線、KY線、覇王線、ラッキーM、仏眼、あやまりま線、フィッシュ、S線、M線などの珍しいまたは話題性のある線が確認できた場合は、最優先で取り上げてください。"
                                "他の項目を短縮してでも、その魅力や意味を楽しく盛り上げて解説してください。\n"
                                "もし特徴的な線が確認できない場合でも、“無い”“見受けられない”“確認できない”などの表現は一切使用せず、"
                                "全体のバランスや印象、他の線との調和から個性や魅力を自然に読み取って解説してください。\n\n"
                                "■ 総合的なアドバイス\n（全体を踏まえた前向きで印象に残るまとめ）\n\n"
                                "・各項目は400文字前後で\n"
                                "・言葉遣いは温かく、読み手が前向きな気持ちになれるように\n"
                                "・「占ってもらってよかった」と思えるように、印象に残るコメントを1つ以上盛り込んでください"
                            ),
                        },
                        {
                            "type": "image_url",
